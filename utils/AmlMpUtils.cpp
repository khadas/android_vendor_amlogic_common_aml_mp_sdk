...
{
    switch (streamType) {
        ENUM_TO_STR(AML_MP_STREAM_TYPE_UNKNOWN);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_VIDEO);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_AUDIO);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_AD);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_SUBTITLE);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_TELETEXT);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_ECM);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_EMM);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_SECTION);
        ENUM_TO_STR(AML_MP_STREAM_TYPE_NB);
        default:
...
const char* mpPlayerEventType2Str(Aml_MP_PlayerEventType eventType) {
    switch (eventType) {
        ...
        //Subtitle
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_BASE);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_DATA);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_SUBTITLE_AVAIL);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_DIMENSION);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_AFD_EVENT);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_CHANNEL_UPDATE);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_SUBTITLE_LANGUAGE);
        ENUM_TO_STR(AML_MP_SUBTITLE_EVENT_SUBTITLE_INFO);
        default:
