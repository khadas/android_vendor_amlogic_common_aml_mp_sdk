...
#ifndef AML_MP_BIT_READER_H_

#define AML_MP_BIT_READER_H_
...
class AmlMpBitReader {
public:
    AmlMpBitReader(const uint8_t *data, size_t size);
    virtual ~AmlMpBitReader();
...
protected:
    ...
    AmlMpBitReader(const AmlMpBitReader&) = delete;
    AmlMpBitReader& operator= (const AmlMpBitReader&) = delete;
};
